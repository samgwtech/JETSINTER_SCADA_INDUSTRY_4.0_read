...
"[project]/app/api/plc/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const RECIPES_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "settings", "recipes.json");
async function GET(req) {
    ...
    const res = await fetch(`${PLC_BASE}/api/get/data?elm=${op}(${index})`, {
        headers: HEADERS
    });
...
async function POST(req) {
    ...
    if (action === "update_recipe" || action === "save_recipe") {
        ...
        if (action === "save_recipe") {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(RECIPES_PATH, JSON.stringify(recipes, null, 2));
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0camt2-._.js.map